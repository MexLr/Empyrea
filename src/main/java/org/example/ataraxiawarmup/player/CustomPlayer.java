...
public class CustomPlayer {
    ...
    public void getCombatExpFromMob(CustomMob mob) {
        ...
        exp *= (1D - levelMulti);
        addCombatExp(exp);
        String message = new StringBuilder().append(ChatColor.BLUE).append("+").append(exp).append(" ").append("(").append(this.combatExp).append("/").append(calcCombatToNextLevel()).append(")").toString();
